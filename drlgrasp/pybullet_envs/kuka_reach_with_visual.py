...
class KukaReachVisualEnv(gym.Env):
    ...
    def reset(self):
        ...
        # definition some  limitation white line, notic the observation borde
        p.addUserDebugLine(
        ...
        p.changeVisualShape(table_uid, -1, rgbaColor=[1, 1, 1, 1])  # change the table collor
        # add the object 
